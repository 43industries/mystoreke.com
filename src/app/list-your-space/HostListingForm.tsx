    ...
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      <form
        ...
        onSubmit={async (e) => {
          e.preventDefault();
          setSubmitError("");
          // Simple client-side validations that mirror API rules so hosts get faster feedback.
          if (step === 1) {
            ...
            if (wordCount < 100) {
              setSubmitError("Description must be at least 100 words.");
              return;
            }
          }
          if (step === 4 && formData.photos.length < 3) {
            setSubmitError("Please add at least 3 photos of your space.");
            return;
          }
          if (canNext) {
            setStep(step + 1);
